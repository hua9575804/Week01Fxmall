...
<!DOCTYPE html>
<!-- saved from url=(0042)http://localhost:8080/cust/goods/copy/list -->
    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="http://localhost:8080/cust/goods/copy/list#" class="dropdown-toggle">
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        <a class="menu-toggler" id="menu-toggler" href="http://localhost:8080/cust/goods/copy/list#">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li class="active open">
                    <a href="http://localhost:8080/cust/goods/copy/list#" class="dropdown-toggle">
                        <i class="icon-list"></i>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="http://localhost:8080/cust/goods/copy/list">文案管理</a>
                    </li>

                </ul><!-- .breadcrumb -->

                <div class="nav-search" id="nav-search">
                    <form name="formSelect" method="post" action="http://localhost:8080/cust/goods/copy/list">
								<span class="input-icon">
									<input type="text" placeholder="文案ID/标题" onkeydown="enterSubmit();" class="nav-search-input" name="searchText" id="searchText" value="">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <!-- <th class="center">
                                                <label>
                                                    <input type="checkbox" id="ckall" name="ckall" class="ace" />
                                                    <span class="lbl"></span>
                                                </label>
                                            </th>-->
                                            <th class="left">操 作</th>
                                            <th class="center">序 号</th>
                                            <th class="left">文案标题</th>
                                        ...
                                        <tr>
                                            <!-- <td class="center">
                                                <label>
                                                    <input type='checkbox' class="ace" name='dg1_RowCheck' id='rowCheck1' value='39201701'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>-->
                                            <c:forEach var="goodsCopy" items="${goodsCopyList}">
                                            <td class="center">
                                                1
                                            </td>
                                            <td class="left" width="103px">
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style="align:center">
                                                    <button class="btn btn-xs btn-primary" onclick="window.open('http://localhost:8080/wenan/show/39201701');">
                                                        <i class=" icon-eye-open bigger-120"></i>
                                                    </button>
                                                    <button class="btn btn-xs btn-info" onclick="window.location.href='/cust/goods/copy/save?copy_id=39201701&amp;tp=2'">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </button>
                                                    <button class="btn btn-xs btn-danger" onclick="trashData('39201701');">
                                                        <i class="icon-trash bigger-120"></i>
                                                    </button>
                                                </div>
                                            </td>
                                            <td class="left">${goodsCopy.copyTitle}</td>
                                            <td class="center">
                                                ${goodsCopy.typeId}
                                            </td>
                                            <td class="center">${goodsCopy.orderNo}</td>
                                        ...
                                        <%--<tr>--%>
                                            <!-- <td class="center">
                                                <label>
                                                    <input type='checkbox' class="ace" name='dg1_RowCheck' id='rowCheck2' value='1887427'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>-->
                                            ...
                                            <%--<td class="left" width="103px">--%>
                                                <%--<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style="align:center">--%>
                                                    ...
                                                    <%--<button class="btn btn-xs btn-primary" onclick="window.open('22')">--%>


                                                        <%--<i class=" icon-eye-open bigger-120"></i>--%>
                                                    <%--</button>--%>

                                                    <%--<button class="btn btn-xs btn-info" onclick="window.location.href='/cust/goods/copy/save?copy_id=1887427&amp;tp=0'">--%>
                                                        <%--<i class="icon-edit bigger-120"></i>--%>
                                                    <%--</button>--%>

                                                    <%--<button class="btn btn-xs btn-danger" onclick="trashData('1887427');">--%>
                                                        <%--<i class="icon-trash bigger-120"></i>--%>
                                                    <%--</button>--%>
                                                <%--</div>--%>
                                            <%--</td>--%>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                <ul class="pagination">
                                                    ...
                                                    <li><a href="http://localhost:8080/cust/goods/copy/list#" class="active">1</a></li>
            ...
            <a href="http://localhost:8080/cust/goods/copy/list#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
        ...
        <script type="text/javascript">
            function trashData(id){
                ...
                $.dialog.confirm('<font color=red>你确定要删除文案数据吗？</font>', function(){
                    $.dialog.tips('数据处理中...',600,'loading.gif');
                    var param = "copy_id="+id+"&now="+new Date().getTime();
                    jQuery.ajax({
                        type: "post",
                        cache : false,
                        url: "/cust/goods/copy/trash",
                        data: param,
